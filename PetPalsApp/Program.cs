...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        while (continueApp)
        {
            ...
            Console.WriteLine("6. List Upcoming Adoption Events");
            Console.WriteLine("7. Register for an Adoption Event");
            Console.WriteLine("8. Create an Adoption Event");
    ...
    static void AddPet(PetDAO petDAO)
    {
        try
        {
            ...
            Pet pet = new Pet(name, age, breed, type);
            petDAO.AddPet(pet);
